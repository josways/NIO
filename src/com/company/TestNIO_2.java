...
//            test7();
    ...
    public static void test1() {
        Path path = Paths.get("D:/", "dev/project/NIO/hello.txt");
    ...
    */
    public static void test2() {
        ...
        Path newPath = path.resolve("D:/dev/project/NIO/1.png");
        System.out.println(newPath);

        Path path2 = Paths.get("1.png");
        Path newPath1 = path2.toAbsolutePath();
    ...
    public static void test3() throws IOException {
        ...
        Path path1 = Paths.get("D:/dev/project/NIO/hello.txt");
        Path path2 = Paths.get("D:/dev/project/NIO/hello2.txt");
    ...
    public static void test4() throws IOException {
        ...
        Path dir = Paths.get("D:/dev/project/NIO/test");
        ...
        Path file = Paths.get("D:/dev/project/NIO/hello3.txt");
    ...
    */
    public static void test5() throws IOException {
        Path path1 = Paths.get("D:/dev/project/NIO/hello2.txt");
        Path path2 = Paths.get("D:/dev/project/NIO/hello7.txt");
...
//        Files.move(path1, path2, StandardCopyOption.ATOMIC_MOVE);
    ...
    public static void test6() throws IOException {
        Path path = Paths.get("D:/dev/project/NIO/hello2.txt");
	...
	*/
    public static void test7() throws IOException {
        SeekableByteChannel newByteChannel = Files.newByteChannel(Paths.get("1.png"), StandardOpenOption.READ);
